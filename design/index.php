	...
	<body id="apage4u" class="<?php $nav ?>">
		<div class="page">
			...
			<article>
				...
				<p>
				    Redesigning a website is a big job - needless to say - and should be handled with care. Nevertheless I decided to migrate this site to HTML5 and to reorganize its structure. Today I am glad to be able to say that the task is nearly finished.
				</p>
					
				<p><time datetime="2011-01-16T13:58Z">Berlin, 16.01.2011 </time></p>
